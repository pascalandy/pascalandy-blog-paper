---
title: "Crypto In Montreal"
author: Pascal Andy
date_created: 2017-11-01
tags:
  - projets
description: "Crypto In Montreal est un événement au sujet des cryptomonnaies et du blockchain. 41 meetups organisés depuis 2017."
ogImage: ../../assets/images/og-legacy/2019/05/cim-logo-general.jpg
---

Crypto In Montreal est un événement au sujet des cryptomonnaies et du blockchain. Nos événements ont lieu aux trois ou quatre semaines à Montréal, Québec, Canada.

**#CryptoInMontreal s'adresse à toi** si tu souhaites:
...
- [Mission](#mission)
- [Calendrier & Billets](/blog/calendrier-crypto-in-montreal/)
- [Photos](/blog/cryptoinmontreal-photo/)
- [Code de conduite](/blog/code-de-conduite-de-crypto-in-montreal/)
...
- [Calendrier & Billets](/blog/calendrier-crypto-in-montreal/)
- [Photos des événements](/blog/cryptoinmontreal-photo/)
- [Code de conduite](/blog/code-de-conduite-de-crypto-in-montreal/)
- [Lieux des événements](/blog/les-endroits-qui-acceillent-cryptoinmontreal/)
- [Soumettre une présentation](/blog/comment-soumettre-sa-presentation-pour-cryptoinmontreal/)
- [CryptoInMontreal sur YouTube](/blog/cryptoinmontreal-est-maintenant-sur-youtube/)
- [Billetterie](/blog/billetterie-cim/)
- [Keynotes](/blog/cim-keynote/)
...
Crypto In Montreal a pour mission:

- De **démocratiser le blockchain et les cryptomonnaies**. Nous voulons aider les gens qui désirent commencer à faire leurs premiers pas.
- De **favoriser les triades**, c'est-à-dire créer un environnement propice à la création de nouvelles connexions entre des gens qui ne se connaissent pas. Ce concept m'a été inspiré de David Logan lors de son [TED talk](https://www.youtube.com/watch?v=xTkKSJSqU-I). Ceci est beaucoup plus puissant que de simplement réunir des gens dans une même salle.
- De **réunir les initiés** qui s'intéressent déjà au sujet des cryptomonnaies. Nous pourrons échanger et découvrir les différents enjeux de l'écosystème du blockchain Bitcoin et des Altcoins.
...
Afin de profiter au maximum de ce qu'ils apprendront durant l'événement, je conseille aux invités d'ouvrir un compte sur un marché d'échange au préalable. Voici comment faire [dans ce vidéo](https://www.youtube.com/watch?v=ZUBW4QcdqJo).

---

## Marché d'échanges

- [coinberry.com](https://app.coinberry.com/invite/11588b26230) — Réservé aux participants de CryptoInMontreal et valable sur Coinberry, un marché de change canadien. Selon leurs termes: nous obtiendrons tous les deux **20$**.
...
**Pascal Andy** — Crypto In Montreal a été lancé par Pascal en 2017. Sa [« now page »](/maintenant) est le meilleur endroit pour rapidement connaître ce qu'il fait ces temps-ci.

**Tamara Kara**, biographie en cours.

**Jeremy Kohl**, biographie en cours.

---

## Contacts

Personnellement, je suis très actif sur [Twitter](https://twitter.com/askpascalandy). Voici plusieurs façons de demeurer au courant des prochaines activités de CryptoInMontreal :
...
- [Courriel](/blog/rester-en-contact/)

---

## FAQ (questions et réponses)

- Pour trouver un **événement** se référer à la [liste ci-haut](#tous-les-événements) ou au tag [crypto-in-montreal](/tags/crypto-in-montreal/).
- Dépendamment de l'audience, les rencontres #CryptoInMontreal se déroulent en français et/ou en anglais.
- Les rencontres #CryptoInMontreal se déroulent **en personne**.
...
- La page **Facebook** se trouve ici: [facebook.com/cryptoinmontreal](https://www.facebook.com/cryptoinmontreal)
...
- Index [Crypto20](https://crypto20.com/en/portal/performance/)
- [TradingView](https://www.tradingview.com/chart/hazWQIed/)
