...
author: "Pascal Andy"
description: "Le prochain événement #CryptoInMontreal s’adresse à toi si tu souhaites:
- commencer à investir dans les cryptomonnaies - rencontrer des gens qui s’intéressent au crypto - agrandir ton cercle d’amis et de connaissances"
ogImage: "../../assets/images/og-legacy/2017/12/banner-large-cyptoinmontreal-1.JPG"
---

## Introduction

Le prochain événement #CryptoInMontreal s’adresse à toi si tu souhaites:

- commencer à investir dans les cryptomonnaies
- rencontrer des gens qui s’intéressent au crypto
- agrandir ton cercle d’amis et de connaissances
...
3. FAQ (questions et réponses)

4. Le calendrier 2017 et 2018

## Date et lieu

- **Date** : jeudi 4 janvier 2018
- **Heure** 18h30 à 20h30. (Merci d'arriver 10-15 minutes à l'avance.)
- **Lieu** : We Work L'avenue
- **Adresse** : 1275 Avenue des Canadiens-de-Montréal Montréal, QC H3B 5E8

![WeWork](/og-legacy/2017/12/we-work.jpg)

[WeWork](https://www.wework.com/l/canada) offre à son réseau international de créateurs l’espace de travail, la communauté, et les services dont ils ont besoin afin qu'ils s'épanouissent non seulement dans leur travail et aussi dans leur vie.

## Agenda et déroulement de la soirée

[Lien direct vers YouTube](https://youtu.be/W_FN9-B60ao)

- La soirée est animée par moi, Pascal Andy.

- Chacun des sujets sera discuté environ 15 minutes.

- 7 min entre les différents groupes animés par les **Capitaines**.
- 7 min avec les **Capitaines** où chacun d’entre eux partagera leur opinion sur le sujet à tour de rôle.
- **18h20** — Je nommerai les **Capitaines** pour la soirée. Voir la vidéo ci-dessous pour plus de contexte.
  Je ferai aussi un tour de table pour connaître le niveau de connaissance des invités afin de mieux diriger la soiré.

- **18h40** — Avec l’ensemble des invités sur places, nous déterminerons les 5 grands thèmes à discuter pour la soirée.
...
- **20h30** — Réseautage, rencontre et hasards de la vie.
...
L'admission est **gratuite** et les billets de cet événement [ se trouvent ici](https://www.eventbrite.ca/e/cryptoinmontreal-03-sinitier-aux-cryptomonnaies-bitcoin-ethereum-litecoin-tickets-41286892206).

[![image-rsvp](/og-legacy/2018/01/event-centre-bell-3.jpg)](https://www.eventbrite.ca/e/cryptoinmontreal-03-sinitier-aux-cryptomonnaies-bitcoin-ethereum-litecoin-tickets-41286892206)
