...
Cette page s'adresse aux présentateurs de Crypto In Montreal.

### Checkpoints logistique

- Test de son avec caméra
- Test de son keynote / Ableton
- Lancer la démo SHA256-mining-demo
...
- Grp 1: Curieux, ou je n'connais rien
- Grp 2: Intermédiaire, bonne idée de ce que c'est
- Grp 3: Avancé et au courant de ce qui se passe

### Réseautage

- Rencontres et hasards de la vie.

### Une vie centralisé

Dans l’histoire de l’humanité on remarque qu’il existe quelque façon d'ordonner des groupes de gens:

- Les démocraties (élection)
- Les aristocracies, les monarchies, les dictatures
- Les corporations (banque, Visa, Amazon)

#### Toutes ces façons de faire doivent passé par une entité centralisée.

## Des attributs qui attirent différents groupes

- Décentralisé
- Pseudo-anonyme
- Frais très bas
- Transaction rapide à (l'échelle de la planète)
- Applications décentralisées
- Spéculation

### Trading

- Ordre d'achat et de vente, stop-limit, etc
