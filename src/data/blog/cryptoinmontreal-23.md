...
author: "Pascal Andy"
description: "Apprenez à mettre en place un workflow de trading systématique pour éviter le FUD et le FOMO lors du 23e meetup CryptoInMontreal."
ogImage: "../../assets/images/og-legacy/2018/10/023-cryptoinmontreal.jpg"
---

Pour le **23e événement** de [#CryptoInMontreal](/tags/crypto-in-montreal/), nous parlerons de **trading** et d'une façon de mettre en place un workflow systématique pour trader.

Ce meetup s'addresse aux gens de **tous niveaux**. Je suggère à ceux qui débutent totalement d'assister à ma présentation "Le blockchain, les cryptomonnaies et le mining, ce qu'il faut savoir". Je l'anime régulièrement environ 1 meetup sur 3.

Je favoriserai les échanges et les discussions de groupes. Donc profitez-en pour enmenez vos laptops !

## AGENDA DE LA SOIRÉE

- Mise en place d'un workflow
- Comment bien gérer nos coins sur les marchés de changes et minimiser nos risques
- Comprendre comment faire des ordres
- Comprendre comment exécuté des ordre Limit/Stop
- Comprendre les indicateurs tel que: MACD / RSI
- Stable coins
- Beaucoup de Q&A
- Du café et beacuoup de fun

Les détails de cet événement et l'accès à la billeterie :
[Lire cet article](/posts/cryptoinmontreal-23/)
...
![flyer de l'événement](../../assets/images/og-legacy/2018/10/023-cryptoinmontreal.jpg)
...
P.S. Ça devient problématique quand les gens **confirment leurs présences mais ne se présentent pas**. Faire un **RSVP**, c'est s'engager à être présent à l'événement 🙌. Lorsque vous confirmez votre présence, merci de respecter votre engagement.
...
- [Site web officiel](/tags/crypto-in-montreal/) | [Calendrier 2018](/posts/calendrier-2018-de-cryptoinmontreal/) | [Information générales](/posts/cryptoinmontreal-informations-generales/)
