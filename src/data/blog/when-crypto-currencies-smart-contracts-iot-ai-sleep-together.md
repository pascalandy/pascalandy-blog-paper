...
I make an API request on openride.org, which is a marketplace to arrange a ride for things like me.
...
The price looks too high so I choose to publish on Foursquare. It costs 0.02 LTC to reach about 532 people that are in the area.

bigdatastats.com is telling me 3.67% of them will take action. Cost me 0.05 IOTA to triangulate this info.

I arrive and start distributing my veggie-dog meals.

I’m running low on propane so I make an API request to gazme.tk to get someone or something to deliver the 30 pounds of propane I need to run my stand for the day.

In the contract, I mention they will need to take back my 2 bottles.

_A few hours later..._

I receive a request from partyfood.org to serve a private party and they need 300 veggie-dogs in the next 90 minutes.
...
… then I arrange a ride with droneparty.io
